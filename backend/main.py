...
class ChartAnalysisResponse(BaseModel):
    ...
    trade_setup: dict = {}
    pattern_quality: dict = {}
    market_context: dict = {}
    confirmation: dict = {}
    scenarios: dict = {}
    institutional_interpretation: dict = {}
    ...
    try:
        ...
        if merged.get("analysis_method") == "cv_primary":
            return ChartAnalysisResponse(
                ...
                trade_setup=dict(merged.get("trade_setup", {})),
                pattern_quality=dict(merged.get("pattern_quality", {})),
                market_context=dict(merged.get("market_context", {})),
                confirmation=dict(merged.get("confirmation", {})),
                scenarios=dict(merged.get("scenarios", {})),
                institutional_interpretation=dict(merged.get("institutional_interpretation", {})),
